...
import { addWallet, removeWallet, getWallets, signMessage, addApiKey } from './wallet.controllers';
...
export const AddApiKeyRequestSchema = Type.Object({
  chain: Type.String(),
  network: Type.String(),
  dex_api_key: Type.String(),
})

// Export TypeScript types
export type AddWalletRequest = Static<typeof AddWalletRequestSchema>;
export type AddApiKeyRequest = Static<typeof AddApiKeyRequestSchema>
